...
class Rooms
{
    ...
    /*function save_chat()
	{
		...
		INSERT INTO comments 
			(to_user_id, userid, comment_subject, comment_text, timestamp, comment_status) 
			VALUES (:to_user_id, :userid, :comment_subject, comment_text, :timestamp, :comment_status)
		";
	...
	{
		$query ="
		INSERT INTO comments (comment_id, to_user_id, userid, comment_subject, comment_text, timestamp, comment_status) VALUES 
	...
	function get_all_chat_data()
	{
		...
		OR (comments.userid = :to_user_id AND comments.to_user_id = :userid)";
