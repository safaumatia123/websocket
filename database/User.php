...
class User
{
	...
	{
		$query = "
		INSERT INTO user_table (user_name, user_email, user_password, user_profile, user_status, user_created_on, user_verification_code) 
    ...
    function save_data_fetch_connection(){
	...
	function save_data_connection(){
		$query = "INSERT INTO connection_table (user_id) VALUES (:user_id)";
	...
	function update_user_login_data_connection()
	{
		$query = "
	...
	function get_user_data_by_id_connection()
	{
		$query = "
	...
	{
		$query = "
		SELECT user_id, user_name, user_profile, user_login_status, (SELECT COUNT(*) FROM comments WHERE to_user_id = :user_id AND userid = user_table.user_id AND comment_status = 0) AS count_status FROM user_table
		";
	...
	function update_user_connection_id_connection()
	{
		$query = "
		UPDATE connection_table 
		SET user_connection_id = :user_connection_id 
