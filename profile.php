...
<html>
<head>
	<title>Notification application in php using web scocket programming</title>
	<!-- Bootstrap core CSS -->
		...
		<div class="card">
			<div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right"><a href="index.php" class="btn btn-warning btn-sm">Go to Main Page</a></div>
                </div>
            </div>
            <div class="card-body">
